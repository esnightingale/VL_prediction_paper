...
The following files 
	1. Code scripts used to run the analysis and generate results
		...
		c) 3_random_model_draw - Fit randomly-constructed models from a subset of realistic model components.
		...
		h) input_sim.RData - Input dataset simulated from the final model fit.
